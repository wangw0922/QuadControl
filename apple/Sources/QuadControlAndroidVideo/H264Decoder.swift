...
public final class H264Decoder {
    ...
    private func decodePicture(_ unit: NalUnit) throws {
        ...
        let decodeStatus = VTDecompressionSessionDecodeFrame(
            ...
            // Emit each frame as soon as it decodes. `_EnableTemporalProcessing` asks
            // VideoToolbox to hold frames back and reorder them into presentation order,
            // which is right for playing a recording and wrong for a live mirror — it
            // adds latency for a correctness nobody watching a phone screen needs.
