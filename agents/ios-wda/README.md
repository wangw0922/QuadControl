...
| Press-to-visible latency | Home press → first changed MJPEG frame **0.33 s** (includes the ~0.5 s synchronous XCUITest press); this is the mechanism floor, not bandwidth (37 KB × 23 fps ≈ 0.85 MB/s) |
